...
class clientesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('action', function(clientes $clientes){
                $id = $clientes->id;
                return view('clientes.datatables_actions',compact('clientes','id'));
            })
            ->editColumn('id',function (clientes $clientes){
